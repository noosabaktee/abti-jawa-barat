            ...
            <form class="" method="POST" action="{{ route('profile-club.update', $ProfileClub) }}" enctype="multipart/form-data">
                ...
                <div class="">
                    ...
                    <div class="field">
                        ...
                        <input disabled type="text" name="director"
                    ...
                    <div class="field">
                        ...
                        <input disabled type="text" name="admin"
                    ...
                    <div class="field">
                        ...
                        <input disabled type="text" name="technical_director"
                    ...
                    <div class="field">
                        ...
                        <input disabled type="text" name="training_venue"
                    ...
                    <div class="field">
                        ...
                        <input disabled type="text" name="contact_person"
                    ...
                    <div class="field" style="grid-column:1/-1;">
                        <label>Link</label>
                        <input disabled type="text" name="link"
