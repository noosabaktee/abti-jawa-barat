                ...
                <div class="">
                    ...
                    <div class="grid2">
                        <div class="field"><label>Athletes</label>
                            <input type="text" name="athletes" value="{{ $event->athletes ?? old('athletes') }}" placeholder="168">
                        </div>
                        <div class="field"><label>Coaches</label>
                            <input type="text" name="coaches" value="{{ $event->coaches ?? old('coaches') }}" placeholder="28">
                        </div>
                        <div class="field"><label>Teams</label>
                            <input type="text" name="teams" value="{{ $event->teams ?? old('teams') }}" placeholder="14">
                        </div>
                        <div class="field"><label>Management</label>
                            <input type="text" name="management" value="{{ $event->management ?? old('management') }}" placeholder="18">
                        </div>
                        <div class="field" style="grid-column:1/-1;"><label>Audience Offline / Day</label>
                            <input type="text" name="audience_offline" value="{{ $event->audience_offline ?? old('audience_offline') }}" placeholder="750">
                        </div>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="image-section">
                            <div class="image-preview">
                                <img id="preview-logo"
                                    src="{{ $event->logo ? asset('storage/'.$event->logo) : 'https://placehold.co/400x400?text=Image' }}"
                                    width="150">
                            </div>
                        ...
                        <div class="image-section">
                            <div class="image-preview">
                                <img id="preview-cover"
                                    src="{{ $event->cover ? asset('storage/'.$event->cover) : 'https://placehold.co/400x400?text=Image' }}"
                                    width="150">
                            </div>
