...
<div>
    <div class="section">
        ...
        <div class="sectionBody">
            ...
            <form class="" method="POST" action="{{ route('archive.store') }}" enctype="multipart/form-data">
                @csrf
                <div>
                                ...
                                <div class="field">
                                    ...
                                    <label class="archiveUploadBox" for="doc_pdf_{{ $i }}" data-archive-upload-box>
                                        ...
                                        <div class="archiveUploadState archiveUploadPreview" data-archive-upload-preview hidden>
                                            <a href="#" target="_blank" rel="noopener noreferrer" class="archivePdfLink" data-archive-upload-link>
                                                <div class="archiveUploadPdfIcon">PDF</div>
                                            </a>
                                            <span data-archive-upload-filename>No file chosen</span>
                                        </div>
                                    </label>
                                </div>
