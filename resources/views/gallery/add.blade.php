                        ...
                        <div>
                            <label class="upload-tile" for="image-input-{{ $i }}">
                                ...
                                <div class="upload-preview-wrap" id="preview-wrap-{{ $i }}">
                                    <img id="preview-{{ $i }}" src="" alt="Preview Foto {{ $i }}">
                                </div>
                            </label>
...
<script>
    ...
    document.querySelectorAll('.gallery-input').forEach((input) => {
        input.addEventListener('change', function() {
            ...
            const fileNameId = this.dataset.filenameId;
            const preview = document.getElementById(previewId);
            const placeholder = document.getElementById(placeholderId);
            const filenameEl = document.getElementById(fileNameId);
            const previewWrap = document.getElementById('preview-wrap-' + this.id.replace('image-input-', ''));
            const reader = new FileReader();
